...
> 这篇文章试图回答一个古老的面试问题：当你在浏览器中输入 google.com 并且按下回车之后发生了什么？

> 不过我们不再局限于平常的回答，而是想办法回答地尽可能具体，不遗漏任何细节。

> 该内容转载自 [github项目:what-happen-when](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst)



## 目录

- [按下"g"键](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#g)
- [回车键按下](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id3)
- [产生中断[非USB键盘\]](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#usb)
- [(Windows)一个 `WM_KEYDOWN` 消息被发往应用程序](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#windows-wm-keydown)
- [(Mac OS X)一个 `KeyDown` NSEvent被发往应用程序](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#mac-os-x-keydown-nsevent)
- [(GNU/Linux)Xorg 服务器监听键码值](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#gnu-linux-xorg)
- [解析URL](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#url)
- [输入的是 URL 还是搜索的关键字？](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id4)
- [转换非 ASCII 的 Unicode 字符](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#ascii-unicode)
- [检查 HSTS 列表](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#hsts)
- [DNS 查询](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#dns)
- [ARP 过程](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#arp)
- [使用套接字](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id5)
- [TLS 握手](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#tls)
- [HTTP 协议](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#http)
- [HTTP 服务器请求处理](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id6)
- [浏览器背后的故事](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id7)
- [浏览器](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id8)
- [HTML 解析](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#html)
- [CSS 解析](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#css)
- [页面渲染](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id9)
- [GPU 渲染](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#gpu)
- [Window Server](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#window-server)
- [后期渲染与用户引发的处理](https://github.com/skyline75489/what-happens-when-zh_CN/blob/master/README.rst#id10)
